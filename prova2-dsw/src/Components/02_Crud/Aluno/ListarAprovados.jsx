                ...
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    ...
                    <TableBody>
                        { media>0 &&
                            alunos.map(
                                (aluno)=>{
                                    // esta é a única mudança em comparação ao componente de listagem padrão. Apenas alunos de IRA superior à média serão mapeados. Não há condição para linhas vermelhas pois essa hipótese sequer é possível. 
                                    if(aluno.ira > media )
                                        return (
